...
See the [Supported File Types](./Supported-File-Managers.md) documentation to see the currently supported file types and the [Custom File Updater's](./Supported-File-Managers.md#custom-file-updaters) section to see how to support any other file types.
...
[Read more about the pattern syntax](https://github.com/isaacs/node-glob/tree/v10.3.12?tab=readme-ov-file#glob-primer).
...
[Checkout the `fork.config.js` file to see an example of modifying the accepted types.](../fork.config.js)
